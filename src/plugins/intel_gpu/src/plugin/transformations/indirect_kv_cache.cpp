...
IndirectKVCache::IndirectKVCache() {
    ...
    auto kv_cache = wrap_type<ov::intel_gpu::op::KVCache>({any_input(), any_input(), any_input()});
    ...
    ov::matcher_pass_callback callback = [=](ov::pass::pattern::Matcher& m) {
        ...
        auto indirect_kv_cache = std::make_shared<op::KVCache>(kv_cache_node->get_input_node_shared_ptr(0),
