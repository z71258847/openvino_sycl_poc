...
static void CreateAddOp(Program& p, const std::shared_ptr<ov::op::v1::Add>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::sum);
}

static void CreateMultiplyOp(Program& p, const std::shared_ptr<ov::op::v1::Multiply>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::prod);
}

static void CreateMaximumOp(Program& p, const std::shared_ptr<ov::op::v1::Maximum>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::max);
}

static void CreateMinimumOp(Program& p, const std::shared_ptr<ov::op::v1::Minimum>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::min);
}

static void CreateSubtractOp(Program& p, const std::shared_ptr<ov::op::v1::Subtract>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::sub);
}

static void CreateDivideOp(Program& p, const std::shared_ptr<ov::op::v1::Divide>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::div, {}, op->is_pythondiv());
}

static void CreateSquaredDifferenceOp(Program& p, const std::shared_ptr<ov::op::v0::SquaredDifference>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::squared_diff);
}

static void CreateEqualOp(Program& p, const std::shared_ptr<ov::op::v1::Equal>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::eq);
}

static void CreateNotEqualOp(Program& p, const std::shared_ptr<ov::op::v1::NotEqual>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::ne);
}

static void CreateLessOp(Program& p, const std::shared_ptr<ov::op::v1::Less>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::lt);
}

static void CreateLessEqualOp(Program& p, const std::shared_ptr<ov::op::v1::LessEqual>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::le);
}

static void CreateGreaterOp(Program& p, const std::shared_ptr<ov::op::v1::Greater>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::gt);
}

static void CreateGreaterEqualOp(Program& p, const std::shared_ptr<ov::op::v1::GreaterEqual>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::ge);
}

static void CreateLogicalAndOp(Program& p, const std::shared_ptr<ov::op::v1::LogicalAnd>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::logic_and);
}

static void CreateLogicalOrOp(Program& p, const std::shared_ptr<ov::op::v1::LogicalOr>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::logic_or);
}

static void CreateLogicalXorOp(Program& p, const std::shared_ptr<ov::op::v1::LogicalXor>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::logic_xor);
}

static void CreatePowerOp(Program& p, const std::shared_ptr<ov::op::v1::Power>& op) {
...
static void CreateFloorModOp(Program& p, const std::shared_ptr<ov::op::v1::FloorMod>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::floor_mod);
}

static void CreateModOp(Program& p, const std::shared_ptr<ov::op::v1::Mod>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::mod);
}

static void CreateIsFiniteOp(Program& p, const std::shared_ptr<ov::op::v10::IsFinite>& op) {
    CreateElementwiseOp(p, op, cldnn::eltwise_mode::is_finite);
}

static void CreateIsInfOp(Program& p, const std::shared_ptr<ov::op::v10::IsInf>& op) {
...
static void CreateIsNaNOp(Program& p, const std::shared_ptr<ov::op::v10::IsNaN>& op) {
