...
static void CreateCommonBroadcastOp(Program& p, const std::shared_ptr<ov::Node>& op, const ov::AxisSet axis_mapping) {
...
static void CreateBroadcastOp(Program& p, const std::shared_ptr<ov::op::v1::Broadcast>& op) {
...
static void CreateBroadcastOp(Program& p, const std::shared_ptr<ov::op::v3::Broadcast>& op) {
    validate_inputs_count(op, {2, 3});
