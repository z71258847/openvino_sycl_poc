...
static void CreateCommonConvertColorOp(Program& p, const std::shared_ptr<ov::Node>& op,
...
static void CreateNV12toRGBOp(Program& p, const std::shared_ptr<ov::op::v8::NV12toRGB>& op) {
...
static void CreateNV12toBGROp(Program& p, const std::shared_ptr<ov::op::v8::NV12toBGR>& op) {
    validate_inputs_count(op, {1, 2});
    CreateCommonConvertColorOp(p, op, cldnn::convert_color::color_format::NV12, cldnn::convert_color::color_format::BGR);
}

static void CreateI420toRGBOp(Program& p, const std::shared_ptr<ov::op::v8::I420toRGB>& op) {
...
static void CreateI420toBGROp(Program& p, const std::shared_ptr<ov::op::v8::I420toBGR>& op) {
    validate_inputs_count(op, {1, 3});
