...
TEST(strided_slice_gpu_f32_i32, test_2x2x2x2_full) {
    ...
    auto input = engine.allocate_memory({ { 2, 2, 2, 2 }, data_types::f32, format::bfyx,  });
    auto begin = engine.allocate_memory({ { 4 }, data_types::i32, format::bfyx,  });
    auto end = engine.allocate_memory({ { 4 }, data_types::i32, format::bfyx });
    auto strides = engine.allocate_memory({ { 4 }, data_types::i32, format::bfyx });
...
TEST(strided_slice_gpu_f32_i64, test_2x2x2x2_full) {
    ...
    auto begin = engine.allocate_memory({ { 4 }, data_types::i64, format::bfyx });
    auto end = engine.allocate_memory({ { 4 }, data_types::i64, format::bfyx });
    auto strides = engine.allocate_memory({ { 4 }, data_types::i64, format::bfyx });
...
TEST(strided_slice_gpu_f32_i32, test_2x2x2x1x1) {
    ...
    auto strides = engine.allocate_memory({ { 3 }, data_types::i32, format::bfyx });
