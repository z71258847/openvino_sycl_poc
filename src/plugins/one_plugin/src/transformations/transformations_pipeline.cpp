...
#include "transformations/convert_gather_to_compressed.hpp"
#include "transformations/convert_matmul_to_fc.hpp"
#include "transformations/fc_convert_fusion.hpp"
#include "transformations/kv_cache_fusion.hpp"
#include "transformations/move_fc_reshape_to_weights.hpp"
#include "transformations/bcast_and_pad_zp_buffers.hpp"
#include "transformations/rms_fusion.hpp"
#include "transformations/swiglu_fusion.hpp"
#include "transformations/transpose_matmul_fusion.hpp"
#include "transformations/indirect_kv_cache.hpp"
#include "transformations/convert_convolution.hpp"
#include "transformations/layout_assignment.hpp"
#include "transformations/layout_propagation.hpp"
#include "transformations/insert_reorders.hpp"
#include "transformations/select_implementations.hpp"
#include "transformations/convert_to_extended_opset.hpp"
#include "transformations/markup_nodes.hpp"
...
bool TransformationsPipeline::run_on_model(const std::shared_ptr<ov::Model>& func) {
    ...
    bool unroll_loop = config.get_property(ov::intel_gpu::enable_loop_unrolling);
    {
        ...
        enableInt8 = config.get_property(ov::enable_lp_transformations) && is_model_quantized;
        if (enableInt8) {
        ...
        auto fp_precision_supported = [&](ov::element::Type e) -> bool {
            switch (e) {
                ...
                case ov::element::f64: return false;
        ...
        if (/* device_info.supports_immad */ false) {
...

    {
        ...
        manager.register_pass<ov::intel_gpu::RMSFusion>(128);
